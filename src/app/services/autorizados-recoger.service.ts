import {
  ...
  export class AutorizadosRecogerService {
  
    private servicio = environment.api + 'autorizados-recoger';
    ...
    obtenerActivosHoyPorEstudiante(idEstudiante: any) {
      return this.http
        .get<HttpResponse<Object>>(this.servicio + '/estudiante-hoy/' + idEstudiante, { observe: 'response' })
        .pipe(
          tap((response: HttpResponse<Object>) => {
            let respuesta: any = response.body;
            if (respuesta.error) {
