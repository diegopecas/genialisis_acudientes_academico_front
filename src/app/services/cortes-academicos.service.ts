...
export class CortesAcademicosService {
  private servicio = environment.api + 'cortes-academicos';
  ...
  actualizar(elemento: any): Observable<any> {
    var body = JSON.stringify(elemento);
    console.log("Actualizar corte académico:", body);
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en CortesAcademicosService:', error);
