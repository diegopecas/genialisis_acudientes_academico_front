...
export class IndicadoresLogrosService {
  private servicio = environment.api + 'indicadores-logros';
  ...
  obtenerByLogro(id_logro: any): Observable<HttpResponse<Object>> {
    return this.http
      .get<HttpResponse<Object>>(`${this.servicio}/logro/${id_logro}`, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
  ...
  actualizar(elemento: any): Observable<any> {
    var body = JSON.stringify(elemento);
    console.log("Actualizar indicador de logro:", body);
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en IndicadoresLogrosService:', error);
