...
export class CompetenciasCognitivasService {
  private servicio = environment.api + 'competencias-cognitivas';
  ...
  actualizar(elemento: any): Observable<any> {
    var body = JSON.stringify(elemento);
    console.log("Actualizar competencia cognitiva:", body);
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en CompetenciasCognitivasService:', error);
