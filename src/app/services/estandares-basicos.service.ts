...
export class EstandaresBasicosService {
  private servicio = environment.api + 'estandares-basicos';
  ...
  actualizar(elemento: any): Observable<any> {
    var body = JSON.stringify(elemento);
    console.log("Actualizar estándar básico:", body);
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en EstandaresBasicosService:', error);
