...
export class ValoresMedidasService {
  private servicio = environment.api + 'valores-medidas';
  ...
  obtenerPorMedida(idMedida: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + `/medida/${idMedida}`, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
