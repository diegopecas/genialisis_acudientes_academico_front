...
export class DiasXSprintService {

  private servicio = environment.api + 'dias-x-sprint';
  ...
  obtenerBySprintId(id_sprint: any): Observable<HttpResponse<Object>> {
    return this.http
  ...
  actualizar(elemento: any): Observable<any> {
    var body = JSON.stringify(elemento);
    console.log("Actualizar dias x sprint:", body);
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en DiasXSprintService:', error);
