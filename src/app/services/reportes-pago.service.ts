...
export class ReportesPagoService {
  ...
  obtenerPendientesByColaborador(idColaborador: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/pendientes-colaborador/' + idColaborador, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
  ...
  obtenerPendientesByEstudiante(idEstudiante: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/pendientes-estudiante/' + idEstudiante, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
  ...
  obtenerByPagoRecibido(idPagoRecibido: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/pago-recibido/' + idPagoRecibido, { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
  ...
  obtenerTiposPagoPortal() {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/tipos-pago-portal', { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
  ...
  obtenerColaboradoresActivos() {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + '/colaboradores-activos', { observe: 'response' })
      .pipe(
        tap((response: HttpResponse<Object>) => {
          let respuesta: any = response.body;
          if (respuesta.error) throw respuesta.error;
  ...
  asociarPago(data: any) {
    const body = JSON.stringify(data);
    return this.http.put<any>(this.servicio + '/asociar', body, httpOptions).pipe(
      tap((respuesta: any) => {
        if (respuesta.error) throw respuesta.error;
        return respuesta;
      }),
  ...
  actualizarDocumento(data: { id: number; id_documento_persona: number }) {
    const body = JSON.stringify(data);
    return this.http.put<any>(this.servicio + '/documento', body, httpOptions).pipe(
      tap((respuesta: any) => {
        if (respuesta.error) throw respuesta.error;
        return respuesta;
      }),
